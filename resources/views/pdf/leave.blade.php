...
<body>
    ...
    <ul>
        <li><label>Name:</label> <input type="text" value="{{ $leave->user->first_name }} {{ $leave->user->last_name }}" readonly></li>
    ...
    <ul>
        <li>
            ...
            <input type="text" value="{{ \Carbon\Carbon::parse($leave->start_date)->format('Y/m/d') .'-'. (\Carbon\Carbon::parse($leave->start_date)->format('H:i:s') === '08:00:00' ? 'Full Day' : (\Carbon\Carbon::parse($leave->start_date)->format('H:i:s') === '12:00:00' ? '1st Half' : '2nd Half')) }}" readonly>
        </li>
        <li>
            <label>Leave End Date:</label>
            <input type="text" value="{{ \Carbon\Carbon::parse($leave->end_date)->format('Y/m/d') .'-'. (\Carbon\Carbon::parse($leave->end_date)->format('H:i:s') === '08:00:00' ? 'Full Day' : (\Carbon\Carbon::parse($leave->end_date)->format('H:i:s') === '12:00:00' ? '1st Half' : '2nd Half')) }}" readonly>
        </li>
        ...
        <li>
            ...
            <div class="leave-type-container">
                <input type="checkbox" disabled {{ $leave->leave_type === 'personal_leave' ? 'checked' : '' }}> Personal Leave
