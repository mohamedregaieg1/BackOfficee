...
<body>
    ...
    <ul>
        <li><label>Name:</label> <input type="text" value="<?php echo e($leave->user->first_name); ?> <?php echo e($leave->user->last_name); ?>" readonly></li>
        <li><label>Company:</label> <input type="text" value="<?php echo e($leave->user->company); ?>" readonly></li>
        <li><label>Phone Number:</label> <input type="text" value="<?php echo e($leave->user->phone); ?>" readonly></li>
        <li><label>Email:</label> <input type="text" value="<?php echo e($leave->user->email); ?>" readonly></li>
    </ul>

    <!-- Section : Informations sur le congé -->
    <h2 class="section-title">Leave Information</h2>
    <ul>
        <li>
            <label>Leave Start Date:</label>
            <input type="text" value="<?php echo e(\Carbon\Carbon::parse($leave->start_date)->format('Y/m/d') .'-'. (\Carbon\Carbon::parse($leave->start_date)->format('H:i:s') === '08:00:00' ? 'Full Day' : (\Carbon\Carbon::parse($leave->start_date)->format('H:i:s') === '12:00:00' ? '1st Half' : '2nd Half'))); ?>" readonly>
        </li>
        <li>
            <label>Leave End Date:</label>
            <input type="text" value="<?php echo e(\Carbon\Carbon::parse($leave->end_date)->format('Y/m/d') .'-'. (\Carbon\Carbon::parse($leave->end_date)->format('H:i:s') === '08:00:00' ? 'Full Day' : (\Carbon\Carbon::parse($leave->end_date)->format('H:i:s') === '12:00:00' ? '1st Half' : '2nd Half'))); ?>" readonly>
        </li>
        ...
        <li>
            ...
            <div class="leave-type-container">
                <input type="checkbox" disabled <?php echo e($leave->leave_type === 'personal_leave' ? 'checked' : ''); ?>> Personal Leave
